...
export default function Page() {
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="opensource" className="w-full py-12 relative z-10">
        <BlurFade delay={BLUR_FADE_DELAY * 13}>
          <GithubSection username={DATA.githubUsername} />
        </BlurFade>
      </section>
      <section id="contact" className="relative z-10">
        <div className="grid items-center gap-4 px-4  md:px-6 w-full py-12">
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Vous voulez discuter ? Envoyez-moi simplement un message avec
